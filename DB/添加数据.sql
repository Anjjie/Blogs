...
<br />HTML5相对于以前的HTML4版本，主要朝着语义化、现代化的方向发展，去掉了一些纯表现形式的标签，增加了一些语义化的标签和多媒体标签，更加符合现代开发需要。而CSS3呢，基本上是向下兼容以前的标准，在以前的基础上添加了不少新特性。利用HTML5+CSS3组合，可能简单几行代码就能够实现以前需要很多代码配合js才能实现的功能。','日常','2017-11-24 09:37:00',''
...
.......
<br />
转自：http://www.cnblogs.com/yunfeifei/p/4671930.html' ,'日常','2017-11-24 09:42:00',''



EXEC Insert_Article '日常测试1：检验是否能加载出来','没有报错是最好的选择','日常','2017-11-24 09:37:00',''
EXEC Insert_Article '日常测试2：检验长度是否不会溢出当前装载的html标签；越长越好的名称','没有报错是最好的选择','日常','2017-11-24 09:37:00',''
EXEC Insert_Article '日常测试3：测试数据是否对齐，文字长度溢出后是否消失或者显示...表示','没有报错是最好的选择','日常','2017-11-24 09:37:00',''
EXEC Insert_Article '日常测试4：人类进化论，宇宙大爆炸、银河系毁灭，何去何从？','没有报错是最好的选择','日常','2017-11-24 09:37:00',''
EXEC Insert_Article '日常测试5：文章就是这么乱打出来的测试数据','没有报错是最好的选择','日常','2017-11-24 09:37:00',''
EXEC Insert_Article '日常测试6：文章是什么？什么是文章？你能理解吗？','没有报错是最好的选择','日常','2017-11-24 09:37:00',''
EXEC Insert_Article '日常测试7：文章有什么作用？没用那我们为什么要写呢？','没有报错是最好的选择','日常','2017-11-24 09:37:00',''
EXEC Insert_Article '日常测试8：技术不是问题，问题是没有技术','没有报错是最好的选择','日常','2017-11-24 09:37:00',''
EXEC Insert_Article '日常测试9：学习是个无止境的过程，日积月累，方能成山','没有报错是最好的选择','日常','2017-11-24 09:37:00',''
EXEC Insert_Article '日常测试10：博客是什么？有什么用？为什么要做？怎么做？','没有报错是最好的选择','日常','2017-11-24 09:37:00',''
