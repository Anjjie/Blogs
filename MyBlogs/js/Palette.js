            ...
            init: function (opt) {
                ...
                return this.each(function () {
                    ...
                    if (!$(this).data('colpickId')) {
                        ...
                        //options.currentColor = cal.find('div.One_FontColor_A');
